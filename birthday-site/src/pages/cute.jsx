...
function Cute() {
  ...
  return (
    <div className="cute-page">
      ...
      {/*Middle Center Text*/}
      <div className="you">
        You are quite honestly the kind of person, who, when life gives her lemons, look awkwardly at life and smile because you can’t really figure out what you should do. Thankfully your awkward smiles are one of the prettiest things about you. That works out pretty well.
